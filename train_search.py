...
args.save = 'NASP 40lei15 8channel eval-{}-{}'.format(args.save, time.strftime("%Y%m%d-%H%M%S"))
...
def main():
  ...
  for epoch in range(args.epochs):
    ...
    # ±£´æµ½±¾µØexcel
    df.to_excel(f"result/FS-NASP40lei15 8channel acc_loss.xlsx", index=False)

    utils.save(model, 'model/NASP40lei15 8channel.pt')
